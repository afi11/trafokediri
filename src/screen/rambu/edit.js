...
const EditRambu = ({navigation, route}) => {
  ...
  const _retrieveData = async () => {
    try {
      ...
      setRambu({
        ...
        ['foto_rambu']: route.params.item.foto_rambu,
  ...
  const postData = () => {
    setLoading(true);
    axios
      .put(`${url}api/updaterambulalin/${rambu.id_rambu}`, rambu)
      .then((res) => {
        setLoading(false);
        Snackbar.show({
          ...
          <View style={styles.container_form.twoColumn}>
            ...
            <View style={styles.container_form.twoColumn.div}>
              ...
              <InputText
                ...
                placeholder="Contoh Latitude : 112.0078079"
                error={empty.lang}
                keyboardType="numeric"
              />
            </View>
