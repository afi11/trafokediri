...
const CreateKinerjaJalan = ({navigation}) => {
  ...
  const inputValidate = () => {
    ...
    if (kinerjaJalan.file_foto === '') {
      fotojalan = 'Foto Jalan Wajib diisi.';
    }
  ...
  const postData = () => {
    setLoading(true);
    axios
      .post(`${url}api/create_kinerja_jalan`, kinerjaJalan)
      .then((res) => {
        setLoading(false);
        Snackbar.show({
          ...
          <View style={styles.container_form.twoColumn}>
            <View style={styles.container_form.twoColumn.div}>
              ...
              <InputText
                ...
                onChangeText={(value) => onInputChange(value, 'lat_jalan')}
            ...
            <View style={styles.container_form.twoColumn.div}>
              ...
              <InputText
                ...
                onChangeText={(value) => onInputChange(value, 'long_jalan')}
...
export default CreateKinerjaJalan;
